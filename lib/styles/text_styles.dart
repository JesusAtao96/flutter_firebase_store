...
class AppTextStyles {
  ...
  static final TextStyle textProductStyle = TextStyle(
    fontSize: 14,
    fontWeight: FontWeight.bold,
    color: AppColors.secondaryColor,
  );

  static final TextStyle textPriceStyle = TextStyle(
    fontSize: 14,
    fontWeight: FontWeight.normal,
    color: AppColors.secondaryColor,
  );

  static final TextStyle textProductBarTitleStyle = TextStyle(
    fontSize: 20,
    fontWeight: FontWeight.bold,
    color: AppColors.secondaryColor,
  );
